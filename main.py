"""
Deep Learningbased Network Intrusion Detection — Main Pipeline
==================================================

Research-driven anomaly detection and classification pipeline.

Reference:
    Deep Learning-Based Network Intrusion Detection System for IoT Environ...
...
def main():
    ...
    print("\n" + "=" * 60)
    print("  Deep Learningbased Network Intrusion Detection")
    print("  ML Pipeline")
    print("=" * 60)
